...
const name1 = users1.map(user => user.name.startsWith('A') ? 'Anacleto' : user.name );
console.log(name1);
...
const itsVisited = cities.map(city => city.isVisited ? city.name + ' ' + '(Visitado)' :  city.name) 
console.log(itsVisited)